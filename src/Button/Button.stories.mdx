...
The `<Button>` can be rendered as a link by using `component="a"`. You can make a submit button or reset button with the `type` prop.

<Canvas>
  <Story name="Types">
    <Buttons>
      <Button component="a">Anchor Button</Button>
...
If you want different button sizes for each breakpoint, you can use Bulma's responsive buttons. Simply add the `responsive` prop:
...
<Canvas>
  <Story name="Responsive Sizes">
    <React.Fragment>
      ...
      <p>Responsive</p>
      <Buttons>
        <Button responsive size="small" >Small</Button>
        <Button responsive>Default</Button>
        <Button responsive size="normal">Normal</Button>
        <Button responsive size="medium">Medium</Button>
        <Button responsive size="large">Large</Button>
      </Buttons>
    </React.Fragment>
  </Story>
</Canvas>
